...
<head>
    ...
    <title>Allen Project Crud</title>
    ...
    <div class="max-w-4xl mx-auto">
        <form>
                ...
                <div class="border-b border-white/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2 flex items-center gap-x-3">
                                ...
                                <label for="photo-upload" class="cursor-pointer">
                                    <svg viewBox="0 0 24 24" fill="currentColor" data-slot="icon" aria-hidden="true"
                                        class="size-12 text-gray-500 hover:text-gray-300 transition-colors">
                                        <path
                            ...
                            <p class="mt-2 text-sm/6 text-gray-400">Click the icon or button to upload a photo</p>
                        </div>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button type="button"
                    class="text-sm/6 font-semibold text-white hover:text-gray-300 transition-colors">Cancel</button>
                <button type="submit"
                    class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white hover:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 transition-colors">Save</button>
            </div>
        </form>
    </div>
</body>
